...
===========
.. line-block:: 
    The O.E.M. (which stands for Ore Extraction Machine) is a standard issue pickaxe :ref:`tool <tools>` that players not opted into the :ref:`Technology class<tech_class>` will receive when they embark on their journey.
